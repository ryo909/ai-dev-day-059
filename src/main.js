import './style.css';
const PROFILE = {"day":"Day059","title":"Quote Assumption Watcher","display_name_ja":"見積もり条件ずれ見張り","one_sentence":"複数見積もりの前提条件のずれを見える化するツール","purpose_line_ja":"複数見積もりの前提差を見つけやすくするためのツールです。","use_case_line_ja":"複数社の見積もりが揃っても条件差が読めない時に使います。","how_it_works_line_ja":"条件行を入れると、抜けている前提と聞き返し項目が分かります。","core_action":"compare","family":"quote_assumption_diff","mechanic":"diff_grid","input_style":"assumption_rows","output_style":"assumption_heatmap","output_label":"ここを見ればOKです","audience_promise":"比べるべき違いと確認すべき点がすぐ分かる。","publish_hook":"項目と前提を自分で足し引きしながら並べると、価格差より先に抜け条件と聞き返し項目が見える。","engine":"brief_driven","interaction_archetype":"diff_grid","page_archetype":"comparison_table","ui_variant":"quote","intro_variant":"quote_diff","interaction_model":"edit_assumption_rows_across_vendors","primary_layout":"assumption_grid_with_gap_summary","result_presentation_style":"gap_rows_and_followup_questions","palette_motif":"見積もりネイビー","main_cta":"3社見積もりで試す","input_panel_title":"条件行を並べる","sample_panel_title":"3社見積もりで試す","guide_panel_title":"差分の見どころ","hero_panel_label":"要確認の前提","output_shape":"comparison_table","state_model":"diff_grid_state","core_loop":"assumption_rows -> diff_grid -> assumption_heatmap","component_pack":"comparison_table+assumption_heatmap","scaffold_id":"brief_canvas","single_shot_text_generator":false};
